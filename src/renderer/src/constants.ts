...
export const PROVIDERS = {
  ...
  options: [
    ...
    { value: "claude-code", label: "constants.claudeCodeName" },
  ...
  labels: {
    ...
    "claude-code": "constants.claudeCodeName",
  ...
  setup: [
    ...
    {
      id: "claude-code",
      name: "constants.claudeCodeName",
      desc: "constants.claudeCodeDesc",
      tag: "constants.claudeCodeTag",
      envKey: "",
      url: "",
      placeholder: "",
      configProvider: "claude-code",
      baseUrl: "",
      needsKey: false,
    },
    {
