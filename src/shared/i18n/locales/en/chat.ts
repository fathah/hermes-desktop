export default {
  ...
  worktree: {
    ...
    discardChanges: "Discard unsaved changes to this file?",
    saveFailed: "Could not save this file. Your changes are still open.",
    staleFile: "This file changed on disk. Reload it before saving again.",
    binaryFile: "This file cannot be edited here",
    binaryHint: "Open it in the default application instead.",
  },
  terminal: {
    title: "Terminal",
    show: "Show terminal",
    ...
    resize: "Drag to resize terminal",
    selectFolder: "Select a project folder to open the terminal",
    startFailed: "Could not start the terminal in this folder.",
  },
  folderPicker: {
