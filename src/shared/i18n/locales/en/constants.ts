export default {
  ...
  ollamaDesc: "Run open-weight models locally — Qwen3 / Hermes 4 / Llama 4 / GLM-5 / Gemma",
  ollamaTag: "Local",
  localName: "Local",
  ...
  twitterBearerHint: "App-level Bearer token (X API v2)",
  twitterApiKey: "API Key",
  twitterApiKeyHint: "OAuth 1.0a consumer key (for write operations)",
  twitterApiSecret: "API Secret",
  twitterApiSecretHint: "OAuth 1.0a consumer secret",
  twitterAccessToken: "Access Token",
  twitterAccessTokenHint: "OAuth 1.0a access token",
  twitterAccessTokenSecret: "Access Token Secret",
  twitterAccessTokenSecretHint: "OAuth 1.0a access token secret",
  twitterClientId: "Client ID (OAuth2)",
  twitterClientIdHint: "OAuth 2.0 client ID — only if using OAuth2 PKCE flow",
  twitterClientSecret: "Client Secret (OAuth2)",
  twitterClientSecretHint: "OAuth 2.0 client secret",
  twitterMentionsOnly: "Mentions Only",
  twitterMentionsOnlyHint: "true|false — respond only to @mentions (default: true)",
  twitterDmEnabled: "Direct Messages",
  twitterDmEnabledHint: "true|false — also poll DMs (default: false)",
  twitterAllowedUsers: "Allowed User IDs",
  twitterAllowedUsersHint: "Comma-separated X user IDs (numeric). Empty = no human allowed",
  ...
  platformTwitterDesc: "Post tweets, reply to mentions, send/receive DMs via X API v2",
} as const;
