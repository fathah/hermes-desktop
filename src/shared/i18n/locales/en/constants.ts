export default {
  ...
  orcarouterName: "OrcaRouter",
  orcarouterDesc: "OpenAI-compatible routing gateway",
  ...
  orcarouterApiKey: "OrcaRouter API Key",
  orcarouterHint: "Models from many upstreams via one OrcaRouter key",
