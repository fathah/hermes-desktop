export default {
  ...
  noMemoryEntries: "暫無記憶項目。",
  noToolsetsFound: "未找到工具集。",
  addManuallyHint: "你也可以使用上方的按鈕手動新增記憶。",
  ...
  activate: "啟用",
  providers: {
    honcho: "基於 AI 的跨工作階段使用者輪廓建模，支援辯證問答和語意搜尋",
    hindsight: "長期記憶，具有知識圖譜和多策略檢索功能",
    mem0: "伺服器端 LLM 事實擷取，支援語意搜尋和自動去重",
    retaindb: "雲端記憶 API，支援混合搜尋和 7 種記憶類型",
    supermemory: "語意長期記憶，支援檔案回憶和實體擷取",
    holographic:
      "本機 SQLite 事實儲存，支援 FTS5 搜尋和信任評分（無需 API Key）",
    openviking: "工作階段管理的記憶，支援分層檢索和知識瀏覽",
    byterover: "持久化知識樹，透過 brv CLI 進行分層檢索",
  },
} as const;
