export default {
  ...
  openaiCodexDesc: "使用 Codex OAuth 登入資訊",
  openaiCodexTag: "",
  ...
  customOpenAICompatibleName: "OpenAI 相容 / 本機",
  // Local presets
  lmstudio: "LM Studio",
  ...
  hermesoneHint: "Hermes One 推理服務：快速的點數制閘道",
  openrouterApiKey: "OpenRouter API Key",
  openrouterHint: "使用 OpenRouter 存取 200+ 個模型（建議）",
  openaiApiKey: "OpenAI API Key",
  openaiHint: "直接使用 GPT 模型",
  ollamaCloudApiKey: "Ollama Cloud API Key",
  ollamaCloudHint: "Ollama Cloud 模型需要此 Key",
  ...
  nousHint: "Nous Portal API Key — 如果有 Nous 訂閱，請改用下方 OAuth 卡片。",
  ...
  hfHint: "使用 HF Inference 存取 20+ 個開放模型",
  deepseekApiKey: "DeepSeek API Key",
  deepseekHint: "DeepSeek 程式設計與對話模型",
  togetherApiKey: "Together AI API Key",
  togetherHint: "使用 Together AI 存取 200+ 個開放模型",
  ...
  atlascloudHint: "使用 AtlasCloud 存取 Claude、GPT 與開放模型",
  ...
  tavilyHint: "供 AI Agent 使用的網頁搜尋",
  firecrawlApiKey: "Firecrawl API Key",
  firecrawlHint: "網頁搜尋、擷取與爬網",
  falKey: "FAL.ai Key",
  falHint: "使用 FAL.ai 產生圖片",
  ...
  auxiliaryDescription:
    "輔助工作會處理視覺、壓縮、網頁擷取等旁支工作。自動代表使用主要模型；若特定工作需要便宜或快速的模型，可個別覆寫。",
  auxiliaryResetAll: "全部重設為自動",
  auxiliaryVision: "視覺",
  auxiliaryVisionHint: "圖片/截圖分析",
  auxiliaryWebExtract: "網頁擷取",
  auxiliaryWebExtractHint: "網頁摘要",
  auxiliaryCompression: "壓縮",
  auxiliaryCompressionHint: "脈絡摘要",
  auxiliarySkillsHub: "技能中心",
  auxiliarySkillsHubHint: "技能搜尋/安裝",
  auxiliaryApproval: "核准",
  auxiliaryApprovalHint: "智慧命令核准",
  auxiliaryMcp: "MCP",
  auxiliaryMcpHint: "MCP 工具推理",
  auxiliaryTitleGeneration: "標題產生",
  auxiliaryTitleGenerationHint: "工作階段標題",
  auxiliaryTriageSpecifier: "分流規格補充",
  auxiliaryTriageSpecifierHint: "補完整看板規格",
  auxiliaryKanbanDecomposer: "看板拆解",
  auxiliaryKanbanDecomposerHint: "工作拆解",
  auxiliaryProfileDescriber: "Agent 簡介產生",
  auxiliaryProfileDescriberHint: "自動產生 Agent 簡介",
  auxiliaryCurator: "策展",
  auxiliaryCuratorHint: "技能使用檢視",
  auxiliaryAuto: "自動",
  auxiliaryProviderLabel: "供應商",
  auxiliaryModelLabel: "模型",
  auxiliaryBaseUrlLabel: "Base URL",
  auxiliarySaved: "已儲存輔助工作",
  auxiliaryResetSuccess: "所有輔助工作已重設為自動",
  ...
  mattermostUrlHint: "Mattermost 伺服器位址",
  ...
  emailAddress: "電子郵件位址",
  emailAddrHint: "電子郵件位址",
  emailPassword: "電子郵件密碼",
  emailPassHint: "App 密碼（不是主密碼）",
  smsProvider: "SMS 供應商",
  ...
  platformTelegramDesc: "使用 Bot API 連線 Telegram",
  platformDiscord: "Discord",
  platformDiscordDesc: "使用 bot token 連線 Discord",
  platformSlack: "Slack",
  platformSlackDesc: "連線 Slack 工作區",
  platformWhatsapp: "WhatsApp",
  platformWhatsappDesc: "使用 WhatsApp Business API 連線",
  platformSignal: "Signal",
  platformSignalDesc: "使用 signal-cli 連線",
  ...
  platformEmail: "Email",
  platformEmailDesc: "使用 IMAP/SMTP 收發電子郵件",
  platformSms: "SMS",
  platformSmsDesc: "使用 Twilio 收發簡訊",
  platformImessage: "iMessage",
  platformImessageDesc: "使用 BlueBubbles 伺服器連線",
  platformDingtalk: "釘釘",
  ...
  platformWeixin: "微信",
  platformWeixinDesc: "使用 iLink Bot API 連線",
  platformWebhooks: "Webhooks",
  platformWebhooksDesc: "使用 HTTP webhooks 接收訊息",
