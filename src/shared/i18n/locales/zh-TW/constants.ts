export default {
  ...
  openrouterHint: "透過 OpenRouter 使用 200+ 模型（推薦）",
  ...
  parallelHint: "AI 原生網頁搜尋和擷取",
  tavilyApiKey: "Tavily API Key",
  tavilyHint: "專為 AI 代理設計的網頁搜尋",
  ...
  emailAddress: "電子郵件地址",
  emailAddrHint: "你的電子郵件地址",
  emailPassword: "電子郵件密碼",
  emailPassHint: "應用程式密碼（不是你的主密碼）",
  smsProvider: "SMS 供應商",
  ...
  webhookHint: "用於 webhook 驗證的共用金鑰",
  ...
  platformTelegramDesc: "透過 Bot API 連接 Telegram",
  platformDiscord: "Discord",
  platformDiscordDesc: "透過 bot token 連接 Discord",
  platformSlack: "Slack",
  platformSlackDesc: "連接 Slack 工作區",
  platformWhatsapp: "WhatsApp",
  platformWhatsappDesc: "透過 WhatsApp Business API 連接",
  platformSignal: "Signal",
  platformSignalDesc: "透過 signal-cli 連接",
  platformMatrix: "Matrix",
  platformMatrixDesc: "連接 Matrix/Element 聊天室",
  platformMattermost: "Mattermost",
  platformMattermostDesc: "連接 Mattermost 伺服器",
  platformEmail: "Email",
  platformEmailDesc: "透過 IMAP/SMTP 收發郵件",
  platformSms: "SMS",
  platformSmsDesc: "透過 Twilio 收發簡訊",
  platformImessage: "iMessage",
  platformImessageDesc: "透過 BlueBubbles 伺服器連接",
  platformDingtalk: "釘釘",
  platformDingtalkDesc: "連接釘釘工作區",
  platformFeishu: "飛書 / Lark",
  platformFeishuDesc: "連接飛書工作區",
  platformWecom: "企業微信",
  platformWecomDesc: "連接企業微信",
  platformWeixin: "微信",
  platformWeixinDesc: "透過 iLink Bot API 連接",
  platformWebhooks: "Webhooks",
  platformWebhooksDesc: "透過 HTTP webhooks 接收訊息",
  platformHomeAssistant: "Home Assistant",
  platformHomeAssistantDesc: "連接 Home Assistant",
} as const;
