export default {
  ...
  sshSubtitle:
    "Túnel a un Hermes remoto por SSH — sin puertos expuestos ni API keys.",
  sshHost: "Host SSH",
  sshHostPlaceholder: "192.168.1.100 o myserver.local",
  sshPort: "Puerto SSH",
  sshUsername: "Usuario",
  sshPrivateKey: "Ruta de la clave privada",
  sshPrivateKeyHint: "(opcional — por defecto ~/.ssh/id_rsa)",
  sshRemotePort: "Puerto remoto de Hermes",
  sshRemotePortHint: "(por defecto 8642)",
  sshTesting: "Probando la conexión SSH…",
  sshSystemHintBefore: "Usa el SSH del sistema. Asegúrate de poder ejecutar",
  sshSystemHintAfter: "sin contraseña.",
