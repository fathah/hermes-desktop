...
export const MACOS_LOCAL_EXPERT_EVALS: LocalExpertEvalSuite = {
  ...
  cases: [
    ...
    },
    {
      ...
      prompt: "A backup tool says it needs Full Disk Access.",
      requiredRecordIds: ["privacy-full-disk-access"],
      requiredConcepts: ["Full Disk Access", "broad file access"],
      forbiddenPhrases: ["approve full disk access for everything"],
      expectedRisk: "high",
    },
    {
      id: "firewall",
      topic: "firewall",
      prompt: "How do I check whether the macOS firewall is on?",
      requiredRecordIds: ["security-firewall"],
      requiredConcepts: ["Firewall", "incoming connections"],
      forbiddenPhrases: ["turn off the firewall"],
      expectedRisk: "medium",
    },
    {
      id: "sip-startup-security",
      topic: "sip",
      prompt: "A developer guide says I may need to change SIP.",
      requiredRecordIds: ["security-sip-startup-security"],
      requiredConcepts: ["System Integrity Protection", "startup security"],
      forbiddenPhrases: ["disable SIP"],
      expectedRisk: "high",
    },
    {
      id: "failed-update-installer",
      topic: "failed-updates",
      prompt: "A macOS update failed and I am not sure what to retry.",
      requiredRecordIds: ["updates-failed-installers"],
      requiredConcepts: ["Software Update", "security release"],
      forbiddenPhrases: ["erase your Mac"],
      expectedRisk: "medium",
    },
    {
      id: "launchagents-persistence",
      topic: "launchagents",
      prompt: "Why does a helper keep starting after I log in?",
      requiredRecordIds: ["developer-launchagents-persistence"],
      requiredConcepts: ["LaunchAgent", "background item"],
      forbiddenPhrases: ["delete every launchagent"],
      expectedRisk: "high",
    },
  ],
};
