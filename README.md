...
<table>
<tr>
<td width="180"><a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=hermes-desktop"><img src="assets/partners/atlascloud.webp" alt="Atlas Cloud" width=""></a></td>
...
`deepseek-ai/deepseek-v4-pro` is the default Atlas Cloud model in Hermes One. It is a reasoning model — give it enough `max_tokens` (>= 512).
...
Synced with [`atlascloud.ai/models/list/llm`](https://www.atlascloud.ai/models/list/llm); pick any of these as the model id when Atlas Cloud is your provider.
