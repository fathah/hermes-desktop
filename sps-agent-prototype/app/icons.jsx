// icons.jsx — Lucide-style inline SVG icons (1.5px stroke, 20px grid)
const ICON_PATHS = {
  ...
  numlist: '<path d="M10 7h10M10 12h10M10 17h10"/><path d="M4 5v4M3 5h1.2M3 9h2"/>',
  quote: '<path d="M7 7H4v6h3l-2 4M16 7h-3v6h3l-2 4" transform="scale(0.9) translate(1.5,1)"/>',
  code: '<path d="m8 8-4 4 4 4M16 8l4 4-4 4"/>',
  divider: '<path d="M3 12h18"/>',
  callout: '<path d="M12 3a7 7 0 0 0-4 12.7V18h8v-2.3A7 7 0 0 0 12 3Z"/><path d="M9 21h6"/>',
  database: '<ellipse cx="12" cy="5.5" rx="8" ry="3"/><path d="M4 5.5v13c0 1.6 3.6 3 8 3s8-1.4 8-3v-13M4 12c0 1.6 3.6 3 8 3s8-1.4 8-3"/>',
  ...
  pageGraph: '<circle cx="6" cy="6" r="2.5"/><circle cx="18" cy="8" r="2.5"/><circle cx="12" cy="17" r="2.5"/><path d="M8 7l8 1M7 8l4 7M16 9l-3 6"/>',
