...
`deepseek-ai/deepseek-v4-pro` es el modelo de Atlas Cloud por defecto en Hermes Desktop. Es un modelo de razonamiento — dale suficientes `max_tokens` (>= 512).

<details>
<summary>Todos los modelos de chat de Atlas Cloud (59)</summary>

<br/>

Sincronizado con [`atlascloud.ai/models/list/llm`](https://www.atlascloud.ai/models/list/llm); elige cualquiera de estos como id de modelo cuando uses Atlas Cloud como proveedor.
