...
[[src/renderer/src/components/settings/DataPane.tsx#DataPane]] escapes the detected legacy-install path before interpolating it into trusted localized markup, preserving code styling without treating filesystem data as HTML.
